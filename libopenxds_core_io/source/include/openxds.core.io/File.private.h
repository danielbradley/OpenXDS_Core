...
EXPORT	unsigned int             File_write(       File* self, const byte* buffer, unsigned int bufferSize );
EXPORT	unsigned int              File_read( const File* self,       byte* buffer, unsigned int bufferSize );
